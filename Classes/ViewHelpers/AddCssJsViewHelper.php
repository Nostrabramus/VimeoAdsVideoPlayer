<?php
namespace Aip\AipVimeo\ViewHelpers;
/***************************************************************
 *  Copyright notice
 *
...
class AddCssJsViewHelper extends  \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper{
    /**
    ...
    public function render($file = NULL, $moveToFooter = FALSE) {
        if ($file) {
            \Aip\AipVimeo\Utility\Div::addCssJsFile(
                $file,
                $moveToFooter
            );
        }
